...
Full mode. Load when deciding whether to open another document.
...
So stop when the next document would only add detail to what you hold. Keep
going while it could still revise a key value or the shape of the problem.
Then name in contract item 7 which of those two conditions fired.
