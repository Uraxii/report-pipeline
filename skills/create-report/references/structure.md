...
- The first paragraph states the thesis and names what the report covers and
  in what order.
- The body follows that order exactly. Nothing in the body that the first
  paragraph did not promise.
- Each segment carries a subhead that states the segment's sub-conclusion, not
  its topic. The reader must learn the topic and the point being made about it
  from the subhead alone.
- Read the subheads alone, top to bottom, and they must carry the argument.

A subhead states a point, not a topic:
...
One level below the segment. Every paragraph is a unit of thought, not of
length, and makes one point distinct from the paragraphs on either side of it.
Build it in four moves. [Daniel, RFR-para]

1. **Say it.** State the point in the first sentence, pitched so an
   unspecialized reader grasps it. Carry the technical load later.
2. **Explain it.** Say what the point means and how you will show it.
...
- Voice: single issue, speaking notes that stand alone for basic
  understanding.
- Job: notes to carry into a planned presentation or briefing.
...
**Position paper.**
- Length: multi-page, full sentences, numbered paragraphs.
- Voice: prose that argues.
- Job: circulate, evaluate, or advocate one proposal and ask the reader to
  adopt it.
...
- **Purpose in the first sentence.** No preliminary pleasantries. Get to the
  point at once.
- **Everything the reader must have, and nothing more.** Give all the
  information the reader needs (times, dates, places, prices, payment
  instructions) and volunteer no detail beyond that; extra detail is exposure.
- **Specific dates, never "today" or "tomorrow."** Write the date out.
- **Absolute clarity on the response.** State exactly what response is
  expected, or what steps are to be taken, and when, and by whom.

That last rule is the sharpest statement of a recommendation in the whole
...
DESIGN DEFAULT, skill-authored. Not drawn from any source; the corpus does not
...
shape of the argument. A reader who continues must find the body delivering
exactly what the summary promised, in that order; the summary is under the
